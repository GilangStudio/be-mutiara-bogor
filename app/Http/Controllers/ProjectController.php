...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'facility_images.*' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:5120',
            ...
            'siteplan_image.max' => 'Siteplan size cannot exceed 5MB',
            ...
            'facility_images.*.max' => 'Facility image size cannot exceed 5MB',
        ]);

...
class UnitController extends Controller
{
    ...
    public function store(Request $request, Project $project)
    {
        $request->validate([
            ...
            'banner_image' => 'required|image|mimes:jpg,jpeg,png,webp|max:10240',
            'floor_plan_image' => 'nullable|image|mimes:jpg,jpeg,png,webp|max:10240',
            ...
            'floor_plan_image.max' => 'Floor plan image size cannot exceed 10MB',
